...
Once you have created corresponding definitions in Dagster to your Airflow tasks, you can begin to selectively "proxy" execution of some or all of these assets to Dagster while airflow is still controlling scheduling and orchestration.
