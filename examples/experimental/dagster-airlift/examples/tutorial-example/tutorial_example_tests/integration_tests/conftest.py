...
def mark_tasks_migrated_fixture(
    ...
    """Returns a context manager that marks the specified tasks as proxied in the migration state file
    ...
    def mark_tasks_migrated(migrated_tasks: AbstractSet[str]) -> Iterator[None]:
        """Updates the contents of the migration state file to mark the specified tasks as proxied."""
