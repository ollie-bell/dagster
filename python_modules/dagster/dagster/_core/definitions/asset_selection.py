...
class OperandsBasedAssetSelection(AssetSelection):
...
@whitelist_for_serdes
class AndAssetSelection(OperandsBasedAssetSelection):
    def resolve_inner(
        self, asset_graph: BaseAssetGraph, allow_missing: bool
    ) -> AbstractSet[AssetKey]:
        return reduce(
...
@whitelist_for_serdes
class OrAssetSelection(OperandsBasedAssetSelection):
    def resolve_inner(
        self, asset_graph: BaseAssetGraph, allow_missing: bool
    ) -> AbstractSet[AssetKey]:
        return reduce(
...
class ChildBasedAssetSelection(AssetSelection):
...
@whitelist_for_serdes
class SinksAssetSelection(ChildBasedAssetSelection):
    def resolve_inner(
        self, asset_graph: BaseAssetGraph, allow_missing: bool
    ) -> AbstractSet[AssetKey]:
...
@whitelist_for_serdes
class RequiredNeighborsAssetSelection(ChildBasedAssetSelection):
    def resolve_inner(
        self, asset_graph: BaseAssetGraph, allow_missing: bool
    ) -> AbstractSet[AssetKey]:
        selection = self.child.resolve_inner(asset_graph, allow_missing=allow_missing)
...
@whitelist_for_serdes
class RootsAssetSelection(ChildBasedAssetSelection):
    def resolve_inner(
        self, asset_graph: BaseAssetGraph, allow_missing: bool
    ) -> AbstractSet[AssetKey]:
        selection = self.child.resolve_inner(asset_graph, allow_missing=allow_missing)
...
@whitelist_for_serdes
class DownstreamAssetSelection(ChildBasedAssetSelection):
    depth: Optional[int]
    include_self: bool
...
@whitelist_for_serdes
class UpstreamAssetSelection(ChildBasedAssetSelection):
    depth: Optional[int]
    include_self: bool
...
@whitelist_for_serdes
class ParentSourcesAssetSelection(ChildBasedAssetSelection):
    def resolve_inner(
        self, asset_graph: BaseAssetGraph, allow_missing: bool
    ) -> AbstractSet[AssetKey]:
        selection = self.child.resolve_inner(asset_graph, allow_missing=allow_missing)
